	...
	while (true)
	{
		...
		else if (_selectNum2 == 1)
		{
			...
			case 2:
				...
				break;
			case 3:
				if (_money < _inven->acce1.price) break;
				_money -= _inven->acce1.price;
				_inven->itemBuy(6);
				break;
			case 4:
				if (_money < _inven->potion1.price) break;
				_money -= _inven->potion1.price;
				_inven->itemBuy(9);
				break;
			}
		...
		else if (_selectNum2 == 2)
		{
			...
			case 2:
				...
				break;
			case 3:
				if (_money < _inven->acce2.price) break;
				_money -= _inven->acce2.price;
				_inven->itemBuy(7);
				break;
			case 4:
				if (_money < _inven->potion2.price) break;
				_money -= _inven->potion2.price;
				_inven->itemBuy(10);
				break;
			}
		}
		else if (_selectNum2 == 3)
		{
			switch (_selectNum)
			{
			case 1:
				if (_money < _inven->weapon3.price) break;
				_money -= _inven->weapon3.price;
				_inven->itemBuy(2);
				break;
			case 2:
				if (_money < _inven->armor3.price) break;
				_money -= _inven->armor3.price;
				_inven->itemBuy(5);
				break;
			case 3:
				if (_money < _inven->acce3.price) break;
				_money -= _inven->acce3.price;
				_inven->itemBuy(8);
				break;
			}
		}
