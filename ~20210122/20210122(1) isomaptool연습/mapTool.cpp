...
void mapTool::render()
{
	...
	// 설명
	TextOut(getMemDC(), WINSIZEX - 448, 80, "S저장, D로드, F선택타일로 채우기, Z실행취소", strlen("S저장, D로드, F선택타일로 채우기, Z실행취소"));
	TextOut(getMemDC(), WINSIZEX - 448, 100, "1:1번스테이지, 2:2번스테이지", strlen("1:1번스테이지, 2:2번스테이지"));
