...
void imageManager::resizedRender(string strKey, HDC hdc, int destX, int destY, int sourWidth, int sourHeight)
{ // 프레임렌더의 리사이즈버전은 차차 생각..
	image* img = findImage(strKey);
	if (img) img->resizedRender(hdc, destX, destY, sourWidth, sourHeight);
}